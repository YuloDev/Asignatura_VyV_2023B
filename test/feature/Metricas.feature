...
Característica: Obtención de métricas de ventas mensualizadas por vendedor
  ...
  Esquema del escenario: Vendedor evalúa su rendimiento con el número de ventas
    Dado que un vendedor tiene 6 ventas
      ...
      | 2023-12-03 | Cafetera               | 10.0  | 15.0   | 1        |
      | 2023-12-04 | Memoria USB            | 10.0  | 15.0   | 1        |
      | 2023-11-05 | Refrigeración Liquida  | 10.0  | 15.0   | 1        |
      | 2023-11-06 | Cable de Interconexión | 10.0  | 15.0   | 1        |
    ...
    Ejemplos:
      ...
      | 8           | 6      | son inferiores       | superan             | ajustar precios de los productos |
