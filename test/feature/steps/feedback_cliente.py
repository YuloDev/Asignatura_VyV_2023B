...
def step_impl(context):
    ...
    for i in range(1, 6, 1):
        ...
        def step_impl(context):
            ...
            for i in context.pedido.servicio.puntuaciones_calificaciones:
                assert i["porcentaje"] == lista_porcentajes_por_estrella[int(i["estrellas"]) - 1], (
                    "No se tiene el porcentaje "
        ...
        def step_impl(context):
            ...
            assert context.pedido.servicio.puntuaciones_calificaciones[2][
                       "cantidad"] == 3, "No se ha calificado correctamente el producto"
            return True
        ...
        def step_impl(context):
            assert context.pedido.servicio.puntuaciones_calificaciones[2][
                       "cantidad"] == 3, "No se ha aumentado la calificación correctamente"
        ...
        def step_impl(context):
            ...
            for i in range(1, 6, 1):
                ...
                print(lista_causas_obtenidas[i - 1] + " == " + lista_causas_esperadas[i - 1])
                assert lista_causas_obtenidas[i - 1] == lista_causas_esperadas[
                    i - 1], "No se tienen las causas correcta"
